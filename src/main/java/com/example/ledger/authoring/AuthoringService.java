...
public class AuthoringService {
 ...
 private Map<String,Object> generate(ActorContext actor,UUID candidate,String operation,String source,String instruction){
  var input=input(actor,candidate);var prompt=prompts.current(actor,"EXPERIENCE_DRAFT_V2");long started=System.nanoTime();DraftAssistProvider.Result result=null;
  try{
